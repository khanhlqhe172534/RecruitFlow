...
import CandidateBreadCrumb from "../components/Breadcrumbs/CandidateBreadCrumb";
import { Eye, Pencil, UserPlus, ChevronsUpDown } from "lucide-react";
import { useEffect, useState, useCallback } from "react";


function CandidateManagerment() {
                    ...
                    <Row className="mb-4">
                        ...
                        <Col md={3} className="text-end">
                            {hasRecruiterPermission && (
                                <Button variant="warning" className="rounded-pill" onClick={() => setShowAddModal(true)}>
                                    ...
                                    {[
                                        ...
                                        >
                                            ...
                                            {column !== "action" && (
                                                <ChevronsUpDown
                                                    size={20}
                                                    className={`pb-1 ${sortColumn === column
                                                        ? sortOrder === "desc"
                            ...
                            <tbody className="table-group-divider">
                                {
                                    paginatedCandidate?.map((c) => (
                                        <tr key={c._id}>
                                            ...
                                            <td>
                                                <span
                                                    className={`px-2 inline-flex text-sm badge rounded-pill ${c.status?.name === "activated"
                                                        ? "bg-success"
                                                        : "bg-danger"
                                                        }`}
                                                >
                    ...
                    <Form onSubmit={handleAddCandidate}>
                        <Modal.Body>
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    <Form.Group className="mb-3">
                                        <Form.Label className="fw-bold">Address <span className="text-danger">*</span></Form.Label>
                                        <Form.Control
                                            type="text"
                                            name="address"
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control
                                            type="date"
                                            value={currentCandidate?.dob ? currentCandidate.dob.slice(0, 10) : ""}
                                            readOnly
                                        />
                                    </Form.Group>
                                    <Form.Group className="mb-3">
                            ...
                            <Row>
                                ...
                                <Col md={6}>
                                    ...
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Select
                                            name="status"
                                            value={currentCandidate?.status?._id || currentCandidate?.status}
                                            onChange={(e) => setCurrentCandidate({
                                                ...currentCandidate,
                                                status: e.target.value
                                            })}
                                        >
                                            <option value="671c68e1265bb9e80b7d46e2">Activated</option>
                                            <option value="671ecab96110e590a12040cd">Deactivated</option>
                                        </Form.Select>
                                    </Form.Group>
                                </Col>
                            </Row>
...
export default CandidateManagerment;